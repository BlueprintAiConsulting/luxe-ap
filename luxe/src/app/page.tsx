...
export default function HomePage() {
  ...
  const [pickupCity, setPickupCity] = useState("Los Angeles / Beverly Hills (LAX)");
  const [dropoffCity, setDropoffCity] = useState("Van Nuys Private Airport (VNY FBO)");
  ...
  const FLEET_VEHICLES = [
    {
      ...
      features: [
        ...
        "Chilled Beverage Console with Fiji & Crystal Flutes",
        "Acoustic Glass with Electronic Rear Privacy Shades"
      ],
      description: "The gold standard of world-class executive travel. Engineered for discreet CEOs, dignitaries, and discerning passengers requiring unmatched tranquility."
    },
    {
      id: "executive_suv",
      ...
      features: [
        "Extended Wheelbase with Unrivaled Luggage Volume",
        "High-Speed Encrypted 5G Cabin WiFi",
        "Starline Ambient Starlight Headliner",
        "Individual Climate Zones & USB-C Power Ports"
      ],
      description: "Commanding road presence paired with presidential comfort. Perfect for families, executive delegations, and private jet luggage manifests."
    },
    {
      id: "autobiography_lwb",
      name: "Range Rover Autobiography LWB",
      tagline: "Ultra-Luxury All-Terrain Livery",
      passengers: 4,
      luggage: 4,
      hourlyRate: "$195 / hr",
      airportBase: "$245 Base",
      features: [
        "Executive Class Rear Lounge Seating",
        "Meridian Signature Sound System with Active Noise Cancellation",
        "Direct FBO Tarmac Access Certification",
        "Perforated Semi-Aniline Leather Interior"
      ],
      description: "Sophisticated British craftsmanship designed for red-carpet arrivals, mountain retreats, and private aviation tarmac stairs."
    },
    {
      id: "sprinter_jet",
      ...
      features: [
        "Custom Aviation Captain's Chairs with Leg Rests",
        "Dual 4K Displays with Apple TV & HDMI Inputs",
        "Full Nespresso Bar & Custom Refrigerator",
        "Private Forward Partition for Confidential Meetings"
      ],
      description: "A private jet experience on wheels. Designed for corporate roadshows, touring artists, and multi-passenger executive travel."
    }
  ];
    ...
    <div className="min-h-screen bg-[#060608] text-white selection:bg-accent selection:text-neutral-950 font-sans overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#060608]/85 backdrop-blur-xl border-b border-neutral-800/80 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-8 text-xs font-mono uppercase tracking-wider text-neutral-400">
            ...
            <a href="#airspace" className="hover:text-white transition-colors">Airspace Radar</a>
            ...
            <Link href="/pricing" className="hover:text-white transition-colors">Tariffs</Link>
          </nav>
      ...
      <section className="relative pt-32 pb-20 sm:pt-40 sm:pb-32 px-4 sm:px-8 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#12121a] border border-accent/30 text-accent text-xs font-mono font-bold uppercase tracking-widest mb-6 shadow-gold-sm animate-in fade-in slide-in-from-bottom-2 duration-500">
          ...
          <span>Private Aviation Tarmac & Executive Chauffeur Sanctuary</span>
        </div>
        ...
        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold font-serif text-white tracking-tight max-w-5xl leading-[1.1] animate-in fade-in slide-in-from-bottom-3 duration-700">
          Unrivaled Precision Ground Livery for the Global Elite.
        </h1>
        ...
        <p className="mt-6 text-sm sm:text-lg text-neutral-400 font-mono max-w-3xl leading-relaxed animate-in fade-in slide-in-from-bottom-4 duration-1000">
          Direct tarmac private jet transfers, executive motorcade charters, and 24/7 autonomous AI dispatching synchronized with live airspace flight radar.
        </p>
        ...
        <div className="mt-12 w-full max-w-4xl bg-[#0c0c12]/95 backdrop-blur-2xl border border-accent/30 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 text-left relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-neutral-800 pb-4">
            ...
            <span className="text-[11px] font-mono text-neutral-400">All-Inclusive Transparent Pricing • 0 Hidden Fees</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="space-y-1.5">
              <label className="text-[10px] font-mono uppercase tracking-wider text-neutral-400 font-bold flex items-center gap-1">
                <Plane size={12} className="text-accent" /> Destination / FBO Airport
              </label>
              <input
                type="text"
                value={dropoffCity}
            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                <option value="autobiography_lwb">Range Rover Autobiography (LWB)</option>
                <option value="sprinter_jet">Mercedes Sprinter Jet Edition</option>
              </select>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
            <div className="flex items-center gap-4 text-xs font-mono text-neutral-400">
              ...
              <span className="flex items-center gap-1">
                <Clock size={14} className="text-accent" /> 15-Min Curbside Standby Included
              </span>
            </div>
            ...
            >
              <span>Confirm Reservation & Itinerary</span>
              <ArrowRight size={15} />
            </Link>
          </div>
        ...
        <div className="mt-14 pt-8 border-t border-neutral-800/80 w-full grid grid-cols-2 md:grid-cols-4 gap-6 text-center text-xs font-mono text-neutral-400">
          <div className="space-y-1">
            ...
            <div className="text-[11px] text-neutral-500 uppercase tracking-wider">On-Time Flight Guarantee</div>
          </div>
          <div className="space-y-1">
            <div className="text-xl font-bold font-serif text-white">$10,000,000</div>
            <div className="text-[11px] text-neutral-500 uppercase tracking-wider">Commercial Liability Coverage</div>
          </div>
          <div className="space-y-1">
            <div className="text-xl font-bold font-serif text-white">FAA & FBO</div>
            <div className="text-[11px] text-neutral-500 uppercase tracking-wider">Tarmac Badge Certified</div>
          </div>
          <div className="space-y-1">
            <div className="text-xl font-bold font-serif text-accent">24 / 7 / 365</div>
            <div className="text-[11px] text-neutral-500 uppercase tracking-wider">Autonomous AI Dispatch</div>
          </div>
        </div>

      </section>

      {/* 3. THE 4 CROWN FLEET SHOWCASE */}
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="text-center space-y-3 max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-accent/15 border border-accent/30 text-accent text-xs font-mono font-bold uppercase tracking-widest shadow-gold-sm">
              <Car size={13} className="text-accent" /> The Livery Collection
            </div>
            <h2 className="text-3xl sm:text-5xl font-bold font-serif text-white tracking-tight">
              Pristine Fleet. Uncompromised Luxury.
            </h2>
            <p className="text-xs sm:text-sm text-neutral-400 font-mono leading-relaxed">
              Every vehicle in our fleet is late-model, immaculate, and equipped with executive privacy partitions, high-speed WiFi, and bespoke cabin amenities.
            </p>
          </div>
          ...
          <div className="bg-[#0e0e14] border border-accent/20 rounded-3xl p-6 sm:p-10 shadow-2xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-5 bg-[#08080c] border border-neutral-800 rounded-3xl p-6 space-y-4 shadow-xl">
              ...
              <ul className="text-xs font-mono text-neutral-400 space-y-3">
                ...
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                  <span><strong>Meet & Greet:</strong> Digital tablet nameplate at baggage claim or direct tarmac stairs.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                  <span><strong>Non-Disclosure:</strong> 100% strict passenger discretion and privacy protocols.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 rounded-full bg-accent mt-1.5 shrink-0" />
                  <span><strong>Inspection:</strong> 40-point sanitation and mechanical pre-trip inspection before every charter.</span>
                </li>
              </ul>
            </div>
      ...
      {/* 4. AIRSPACE RADAR & PRIVATE AVIATION TARMAC ACCESS */}
      <section id="airspace" className="py-20 px-4 sm:px-8 max-w-7xl mx-auto space-y-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          
          <div className="lg:col-span-6 space-y-6">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-accent/15 border border-accent/30 text-accent text-xs font-mono font-bold uppercase tracking-widest shadow-gold-sm">
              <Plane size={13} className="text-accent" /> Tarmac & FBO Logistics
            </div>
            <h2 className="text-3xl sm:text-5xl font-bold font-serif text-white tracking-tight">
              Synchronized with Private Aviation Airspace.
            </h2>
            <p className="text-xs sm:text-sm text-neutral-400 font-mono leading-relaxed">
              Never worry about delayed flights or tarmac confusion. Our dispatch engine connects directly to live airspace radar (FlightAware & FAA feeds), automatically tracking your tail number and positioning your chauffeur curbside the exact second wheels touch down.
            </p>
            ...
            <div className="space-y-3 font-mono text-xs text-neutral-300">
              <div className="p-3.5 rounded-2xl bg-[#0e0e13] border border-neutral-800 flex items-center gap-3">
                ...
                <span><strong>FBO Access:</strong> Signature Aviation, Atlantic Aviation, Jet Aviation, Million Air.</span>
              </div>
              <div className="p-3.5 rounded-2xl bg-[#0e0e13] border border-neutral-800 flex items-center gap-3">
                <Clock size={18} className="text-accent shrink-0" />
                <span><strong>Automated Delay Shift:</strong> If your jet is delayed 2 hours, your chauffeur schedule updates instantly.</span>
              </div>
              <div className="p-3.5 rounded-2xl bg-[#0e0e13] border border-neutral-800 flex items-center gap-3">
                <ShieldCheck size={18} className="text-purple-400 shrink-0" />
                <span><strong>Tarmac Badged Chauffeurs:</strong> Direct vehicle escort to the aircraft stairs where permitted.</span>
              </div>
            </div>
            ...
            >
              ...
              <span>Explore Live Airspace Radar</span>
            </Link>
          </div>
          ...
          <div className="lg:col-span-6 bg-[#0c0c10] border border-neutral-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 relative overflow-hidden">
            <div className="flex items-center justify-between border-b border-neutral-800 pb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold font-mono text-white">Live Ground & Flight Telemetry</span>
              </div>
              <span className="text-[10px] font-mono text-accent">KLAX ➔ KVNY Staging</span>
            </div>
            ...
            <div className="bg-[#050508] border border-neutral-800/80 rounded-2xl p-5 space-y-4 font-mono text-xs">
              <div className="flex items-center justify-between text-neutral-400 text-[11px]">
                <span>Inbound: NetJets Flight NJE-491 (Bombardier Global 7500)</span>
                <span className="text-emerald-400 font-bold">On Final (8 mins)</span>
              </div>
              ...
              <div className="p-3 rounded-xl bg-[#0e0e14] border border-neutral-800 space-y-1">
                ...
                <div className="text-white text-xs">Marcus Bennett • Cadillac Escalade ESV (LUXE-77)</div>
                <div className="text-[10px] text-neutral-500">Curbside Signature Aviation Tarmac Gate 4</div>
              </div>

              <div className="flex items-center justify-between pt-2 text-[10px] text-neutral-500">
                <span>Altitude: 2,400 ft</span>
                <span>Airspeed: 180 kts</span>
                <span className="text-accent">Zero Human Dispatch Delay</span>
              </div>
            </div>

            <p className="text-[11px] text-neutral-500 font-mono text-center">
              Autonomous telemetry links VIP Passenger, Private Jet Crew, and Executive Chauffeur in real time.
            </p>
          </div>
      ...
      <section id="technology" className="py-20 bg-[#08080c] border-y border-neutral-800/80 px-4 sm:px-8">
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="text-center space-y-3 max-w-3xl mx-auto">
            ...
            <h2 className="text-3xl sm:text-5xl font-bold font-serif text-white tracking-tight">
              24/7 AI Voice Dispatch. Zero Wait Time.
            </h2>
            <p className="text-xs sm:text-sm text-neutral-400 font-mono leading-relaxed">
              Experience the future of concierge dispatching. Our voice intelligence answers in 1 ring, quotes instant charters, streams live chauffeur GPS, and manages itinerary changes with bespoke British and American executive personas.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-6 rounded-3xl bg-[#0e0e14] border border-neutral-800 space-y-3">
              ...
              <h3 className="text-base font-bold text-white">1-Tap Apple Pay Quotes</h3>
              <p className="text-xs text-neutral-400 font-mono leading-relaxed">
                Calculates exact mileage and tariff rules instantly, then texts a secure 1-tap Apple Pay confirmation link to your mobile phone.
              </p>
            </div>
            ...
            <div className="p-6 rounded-3xl bg-[#0e0e14] border border-neutral-800 space-y-3">
              ...
              <h3 className="text-base font-bold text-white">Live Chauffeur GPS Lookups</h3>
              <p className="text-xs text-neutral-400 font-mono leading-relaxed">
      ...
      {/* 6. CORPORATE ACCOUNTS & FAMILY OFFICE PORTAL */}
      <section id="corporate" className="py-20 px-4 sm:px-8 max-w-7xl mx-auto space-y-12">
        <div className="bg-gradient-to-br from-[#101018] to-[#08080c] border border-accent/30 rounded-3xl p-8 sm:p-14 shadow-2xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-8 space-y-5">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-accent/15 border border-accent/30 text-accent text-xs font-mono font-bold uppercase tracking-widest shadow-gold-sm">
              <Building2 size={13} className="text-accent" /> Enterprise & Family Office
            </div>
            ...
            <p className="text-xs sm:text-sm text-neutral-400 font-mono leading-relaxed">
              Designed for C-suite executive assistants, travel managers, and family offices. Manage multi-city roadshows, book for multiple executives simultaneously, and receive consolidated monthly invoicing with itemized PDF tax receipts.
            </p>
      ...
      <footer className="bg-[#040406] border-t border-neutral-800/80 py-16 px-4 sm:px-8 text-neutral-400 font-mono text-xs">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 pb-12 border-b border-neutral-800/80">
          ...
          <div className="space-y-3">
            ...
            <p className="text-[11px] leading-relaxed text-neutral-500">
              Ultra-luxury ground transportation and private aviation tarmac livery. Serving major global private airports and executive metropolitan corridors.
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1 text-[11px] text-neutral-500">
              ...
              <li><a href="#airspace" className="hover:text-white transition-colors">Airspace Radar</a></li>
        ...
        <div className="max-w-7xl mx-auto pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[10px] text-neutral-600">
          <div>© {new Date().getFullYear()} LUXE Private Aviation Livery. All rights reserved.</div>
