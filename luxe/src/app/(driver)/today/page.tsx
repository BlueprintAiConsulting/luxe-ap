    ...
    <div className="p-4 space-y-6 motion-safe:animate-in motion-safe:fade-in motion-safe:slide-in-from-bottom-4">
      ...
      {trips.length === 0 ? (
        <div className="text-center bg-neutral-900/80 border border-neutral-800 rounded-3xl py-20 px-8 mt-6">
          ...
          <h2 className="text-2xl font-bold mb-3 text-white tracking-tight">No Trips Assigned Today</h2>
          <p className="text-neutral-400 max-w-sm mx-auto text-sm leading-relaxed mb-6">
            Your schedule is currently open. Standby for live dispatch notifications or check your upcoming schedule.
          </p>
          <div className="inline-flex items-center gap-2 text-xs font-semibold text-neutral-400 bg-neutral-800/80 px-4 py-2 rounded-full border border-neutral-700/50">
            <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
            Dispatch Live & Monitoring
          </div>
        </div>
      ) : (
              ...
              >
                ...
                <div className="pt-4 border-t border-neutral-800 flex justify-between items-center text-sm">
                  <div className="flex items-center">
                    <div className="w-8 h-8 rounded-full bg-neutral-800 border border-neutral-700 flex items-center justify-center mr-3 overflow-hidden">
