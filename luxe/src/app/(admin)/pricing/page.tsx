              ...
              return (
                <div key={classId} className="p-4 rounded-2xl bg-white border border-neutral-100">
                  ...
                  <div className="space-y-3">
                    <div><label className="block text-xs text-neutral-500">Base Fare ($)</label><input type="number" value={rates.baseFareCents / 100} onChange={e => updateRates(classId, 'baseFareCents', parseFloat(e.target.value) * 100)} className="w-full border border-neutral-200 p-2 rounded-xl focus:border-brand focus-visible:ring-2 focus-visible:ring-brand/20 focus-visible:outline-none transition-all bg-white" /></div>
                    <div><label className="block text-xs text-neutral-500">Per Mile ($)</label><input type="number" value={rates.perMileCents / 100} onChange={e => updateRates(classId, 'perMileCents', parseFloat(e.target.value) * 100)} className="w-full border border-neutral-200 p-2 rounded-xl focus:border-brand focus-visible:ring-2 focus-visible:ring-brand/20 focus-visible:outline-none transition-all bg-white" /></div>
                    <div><label className="block text-xs text-neutral-500">Per Minute ($)</label><input type="number" value={rates.perMinuteCents / 100} onChange={e => updateRates(classId, 'perMinuteCents', parseFloat(e.target.value) * 100)} className="w-full border border-neutral-200 p-2 rounded-xl focus:border-brand focus-visible:ring-2 focus-visible:ring-brand/20 focus-visible:outline-none transition-all bg-white" /></div>
                    <div><label className="block text-xs text-neutral-500">Minimum Fare ($)</label><input type="number" value={rates.minimumFareCents / 100} onChange={e => updateRates(classId, 'minimumFareCents', parseFloat(e.target.value) * 100)} className="w-full border border-neutral-200 p-2 rounded-xl focus:border-brand focus-visible:ring-2 focus-visible:ring-brand/20 focus-visible:outline-none transition-all bg-white" /></div>
                    <div><label className="block text-xs text-neutral-500">Hourly Rate ($)</label><input type="number" value={rates.hourlyRateCents / 100} onChange={e => updateRates(classId, 'hourlyRateCents', parseFloat(e.target.value) * 100)} className="w-full border border-neutral-200 p-2 rounded-xl focus:border-brand focus-visible:ring-2 focus-visible:ring-brand/20 focus-visible:outline-none transition-all bg-white" /></div>
                    <div><label className="block text-xs text-neutral-500">Hourly Min (Hours)</label><input type="number" value={rates.hourlyMinimumHours} onChange={e => updateRates(classId, 'hourlyMinimumHours', parseInt(e.target.value))} className="w-full border border-neutral-200 p-2 rounded-xl focus:border-brand focus-visible:ring-2 focus-visible:ring-brand/20 focus-visible:outline-none transition-all bg-white" /></div>
                  </div>
                </div>
              );
            })}
