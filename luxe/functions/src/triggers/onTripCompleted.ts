...
import { generateExecutiveInvoiceHtml } from "../api/invoice";
 ...
 */
export const onTripCompleted = onDocumentWritten("reservations/{reservationId}", async (event) => {
  ...
  if (beforeData?.status !== "completed" && afterData.status === "completed") {
    ...
    const invoiceHtml = generateExecutiveInvoiceHtml(afterData);
