...
exports.sendTripInvoice = void 0;
exports.generateExecutiveInvoiceHtml = generateExecutiveInvoiceHtml;
 ...
 */
function generateExecutiveInvoiceHtml(reservation) {
    ...
    const pickupAddress = reservation.pickup?.formatted || "Pickup Location";
    const dropoffAddress = reservation.dropoff?.formatted || "As-Directed Hourly";
    return `
<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="container">
    ...
    <div class="grid" style="margin-top: 12px;">
      ...
      ${reservation.squareReceiptUrl ? `
      <div class="row">
        <div class="col col-label">Square Receipt</div>
        <div class="col col-val"><a href="${reservation.squareReceiptUrl}" style="color: #c59a58;" target="_blank">View Official Square Receipt</a></div>
      </div>` : ""}
    </div>
 ...
 */
exports.sendTripInvoice = (0, https_1.onCall)(async (request) => {
    if (!request.auth) {
        throw new https_1.HttpsError("unauthenticated", "Authentication required to send invoices.");
    }
    ...
    if (!targetEmail) {
        throw new https_1.HttpsError("invalid-argument", "No recipient email found for this reservation.");
    }
