...
exports.onFlightDelayDetected = void 0;
 ...
 */
exports.onFlightDelayDetected = (0, firestore_1.onDocumentWritten)("reservations/{reservationId}", async (event) => {
    ...
    if (afterData.flightNumber &&
        ...
        const currentPickup = afterData.pickupAt;
...
//# sourceMappingURL=onFlightDelayDetected.js.map